...
class PgHTMLTemplateElement extends HTMLTemplateElement {
...
!customElements.get('pg-if-template') ? customElements.define('pg-if-template', PgHTMLTemplateElement, {extends: 'template'}) : null;
